                    ...
                    <li
                        ...
                        <div class="collapse" id="settings">
                            <ul class="nav nav-collapse">
                                ...
                                <li>
                                    <a href="{{ route('manage_images') }}">
                                        <span class="sub-item">Frontend Images &amp; Banners</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('frontpage') }}">
                                        <span class="sub-item">Frontend FAQs &amp; Content</span>
                                    </a>
                                </li>
                                <li>
