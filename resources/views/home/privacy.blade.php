        ...
        <div class="rbc-container" style="max-width: 900px;">
            <div class="rbc-auth-card" style="margin: 0; max-width: 100%; padding: 40px;">
                ...
                <div style="color: var(--rbc-text-secondary); line-height: 1.7; font-size: 0.95rem; display: flex; flex-direction: column; gap: 20px;">
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">1. Our Commitment to Your Privacy</h3>
                    ...
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">2. Information We Collect</h3>
                    ...
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">3. Cookies &amp; Digital Tracking</h3>
                    ...
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">4. Data Retention &amp; Security Standards</h3>
