    ...
    <section class="rbc-section" style="background-color: var(--rbc-bg);">
        <div class="rbc-container" style="max-width: 900px;">
            <div class="rbc-auth-card" style="margin: 0; max-width: 100%; padding: 40px;">
                ...
                <p style="font-size: 0.88rem; color: var(--rbc-text-muted); margin-bottom: 28px;">Accessibility &amp; Inclusion Compliance Framework</p>

                <div style="color: var(--rbc-text-secondary); line-height: 1.7; font-size: 0.95rem; display: flex; flex-direction: column; gap: 20px;">
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">1. Web &amp; Digital Platform Standards</h3>
                    ...
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">2. Assistive Advisory Hub Services</h3>
                    ...
                    <div>
                        <h3 style="color: var(--rbc-navy); font-size: 1.2rem; margin-bottom: 6px;">3. Alternate Document Formats</h3>
