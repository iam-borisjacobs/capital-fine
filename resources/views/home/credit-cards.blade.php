...
@section('content')
        ...
        <div class="fl-container" style="position: relative; z-index: 2;">
            <div style="max-width: 720px; padding: 40px 0;">
                ...
                <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                    <a href="{{ route('register') }}" class="fl-btn-signin" style="padding: 12px 28px; font-size: 1rem;">Apply Online in Minutes <i class="fas fa-arrow-right"></i></a>
                    <a href="{{ route('rewards') }}" class="fl-btn-secondary" style="border-color: #ffffff; color: #ffffff;">Explore Rewards Perks</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="fl-section" style="background-color: var(--fl-bg);">
        <div class="fl-container">
            <h2 class="fl-section-title">Featured Global Cards</h2>
            <p class="fl-section-subtitle">Select the card that matches your lifestyle, international travel, or business enterprise needs.</p>
            ...
            <div class="fl-ecosystem-grid">
                ...
                <div class="fl-ecosystem-card">
                    ...
                    <span class="fl-badge-pill" style="align-self: flex-start; margin-bottom: 8px;">Top Travel &amp; Elite</span>
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 4px;">Aurum Elite World Metal</h3>
                    <p style="font-size: 0.88rem; color: var(--fl-text-muted); margin-bottom: 16px;">Annual Facility: <strong>$120</strong> | Rate: <strong>19.99%</strong></p>
                    ...
                    <div style="margin-top: auto;">
                        <a href="{{ route('register') }}" class="fl-btn-primary" style="width: 100%; justify-content: center;">Apply for Aurum Elite</a>
                    </div>
                </div>
                ...
                <div class="fl-ecosystem-card">
                    <div style="height: 180px; background: linear-gradient(135deg, #15803d 0%, #166534 100%); border-radius: 12px; display: flex; flex-direction: column; justify-content: space-between; padding: 18px; color: #ffffff; margin-bottom: 18px; box-shadow: 0 8px 20px rgba(0,0,0,0.2);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 800; font-size: 0.95rem; color: var(--fl-gold);"><i class="fas fa-coins"></i> REWARDS PLUS</span>
                    ...
                    <span class="fl-badge-pill" style="align-self: flex-start; margin-bottom: 8px; background: #e0f2fe; color: #0369a1; border-color: #bae6fd;">Top Rewards</span>
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 4px;">Apex Value Rewards Card</h3>
                    <p style="font-size: 0.88rem; color: var(--fl-text-muted); margin-bottom: 16px;">Annual Fee: <strong>$0</strong> First Year | Rate: <strong>20.99%</strong></p>
                    ...
                    <div style="margin-top: auto;">
                        <a href="{{ route('register') }}" class="fl-btn-primary" style="width: 100%; justify-content: center;">Apply for Apex Rewards</a>
                    </div>
                </div>
                ...
                <div class="fl-ecosystem-card">
                    ...
                    <span class="fl-badge-pill" style="align-self: flex-start; margin-bottom: 8px; background: #fef3c7; color: #92400e; border-color: #fde68a;">Lowest APR</span>
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 4px;">Low Rate Preferred Smart Card</h3>
                    <p style="font-size: 0.88rem; color: var(--fl-text-muted); margin-bottom: 16px;">Annual Fee: <strong>$20</strong> | Facility Rate: <strong>12.99%</strong></p>
                    ...
                    <div style="margin-top: auto;">
                        <a href="{{ route('register') }}" class="fl-btn-primary" style="width: 100%; justify-content: center;">Apply for Low Rate</a>
                    </div>
                </div>
            </div>
        </div>
