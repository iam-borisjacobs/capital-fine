...
@section('title', 'Credit Cards - Cash Back, Travel Rewards & Low Rate')
...
@section('content')
        ...
        <div class="rbc-container" style="position: relative; z-index: 2;">
            <div style="max-width: 720px; padding: 40px 0;">
                <span class="rbc-badge-pill" style="background: rgba(254, 209, 0, 0.2); color: #fed100; border-color: rgba(254, 209, 0, 0.4);">
                    <i class="fas fa-credit-card"></i> CREDIT CARD SUITE
                </span>
                <h1 style="font-size: 2.8rem; font-weight: 800; color: #ffffff; margin-bottom: 16px; line-height: 1.15;">
                    Find the Perfect Card for Travel, Cash Back &amp; Low Interest
                </h1>
                <p style="font-size: 1.2rem; color: rgba(255, 255, 255, 0.9); margin-bottom: 28px;">
                    Earn up to 70,000 welcome reward points, get 2% cash back on everyday essentials, and enjoy worldwide VIP concierge access.
                </p>
    ...
    <section class="rbc-section" style="background-color: var(--rbc-bg);">
        <div class="rbc-container">
            <h2 class="rbc-section-title">Featured Credit Cards</h2>
            <p class="rbc-section-subtitle">Select the card that matches your lifestyle, travel habits, or business needs.</p>
            ...
            <div class="rbc-ecosystem-grid">
                ...
                <div class="rbc-ecosystem-card">
                    ...
                    <p style="font-size: 0.88rem; color: var(--rbc-text-muted); margin-bottom: 16px;">Annual Fee: <strong>$120</strong> | Interest: <strong>19.99%</strong></p>

                    <ul class="rbc-feature-list" style="margin-bottom: 24px;">
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> Up to <strong>70,000 Welcome Points</strong> upon qualification</li>
                        ...
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> Comprehensive worldwide travel &amp; trip cancellation insurance</li>
                    </ul>
                ...
                <!-- Card 2: Cash Back Preferred Mastercard -->
                <div class="rbc-ecosystem-card">
                    <div style="height: 180px; background: linear-gradient(135deg, #15803d 0%, #166534 100%); border-radius: 12px; display: flex; flex-direction: column; justify-content: space-between; padding: 18px; color: #ffffff; margin-bottom: 18px; box-shadow: 0 8px 20px rgba(0,0,0,0.2);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 800; font-size: 0.95rem; color: var(--rbc-gold);"><i class="fas fa-coins"></i> CASH BACK PLUS</span>
                    ...
                    <span class="rbc-badge-pill" style="align-self: flex-start; margin-bottom: 8px; background: #e0f2fe; color: #0369a1; border-color: #bae6fd;">Top Cash Back</span>
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--rbc-navy); margin-bottom: 4px;">Cash Back World Mastercard</h3>
                    <p style="font-size: 0.88rem; color: var(--rbc-text-muted); margin-bottom: 16px;">Annual Fee: <strong>$0</strong> First Year | Interest: <strong>20.99%</strong></p>

                    <ul class="rbc-feature-list" style="margin-bottom: 24px;">
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> Up to <strong>2% Unlimited Cash Back</strong> on groceries &amp; fuel</li>
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> 1% Cash back on all other eligible credit card purchases</li>
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> Zero liability protection for fraudulent charges</li>
                    </ul>
                    <div style="margin-top: auto;">
                        <a href="{{ route('register') }}" class="rbc-btn-primary" style="width: 100%; justify-content: center;">Apply for Cash Back</a>
                    </div>
                </div>

                <!-- Card 3: Low Rate Visa -->
                <div class="rbc-ecosystem-card">
                    <div style="height: 180px; background: linear-gradient(135deg, #0369a1 0%, #002244 100%); border-radius: 12px; display: flex; flex-direction: column; justify-content: space-between; padding: 18px; color: #ffffff; margin-bottom: 18px; box-shadow: 0 8px 20px rgba(0,0,0,0.2);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 800; font-size: 0.95rem; color: #ffffff;"><i class="fas fa-percent"></i> LOW RATE VISA</span>
                            <i class="fas fa-wifi"></i>
                        </div>
                    ...
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--rbc-navy); margin-bottom: 4px;">Low Rate Preferred Card</h3>
                    <p style="font-size: 0.88rem; color: var(--rbc-text-muted); margin-bottom: 16px;">Annual Fee: <strong>$20</strong> | Interest: <strong>12.99%</strong></p>

                    <ul class="rbc-feature-list" style="margin-bottom: 24px;">
                        <li style="display: flex; gap: 10px; font-size: 0.88rem;"><i class="fas fa-check-circle" style="color: #16a34a; margin-top: 3px;"></i> Fixed <strong>12.99% Low Interest Rate</strong> on all purchases</li>
