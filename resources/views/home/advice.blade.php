...
<!-- HERO -->
        ...
        <div class="rbc-container">
            <div style="max-width: 720px; padding: 30px 0;">
                ...
                <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                    <a href="{{ route('contact') }}" class="rbc-btn-signin" style="padding: 12px 28px; font-size: 1rem;">Book Consultation <i class="fas fa-arrow-right"></i></a>
    ...
    <section class="rbc-section" style="background-color: var(--rbc-bg);">
        <div class="rbc-container">
            <h2 class="rbc-section-title">Latest Research &amp; Capital Commentary</h2>
            <p class="rbc-section-subtitle">Actionable intelligence for private clients, family offices, and enterprise treasurers.</p>
            ...
            <div class="rbc-article-grid">
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Economy &amp; Real Estate</span>
                        <h3 class="rbc-article-title">How Benchmark Rate Cycles Impact Real Estate &amp; Structured Facilities</h3>
                        <p class="rbc-article-snippet">Understand what macroeconomic inflation shifts mean for fixed asset yields, debt pricing, and liquidity management.</p>
                    </div>
                </div>
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Wealth &amp; Estate Planning</span>
                        <h3 class="rbc-article-title">The 5-Pillar Strategy for Sovereign Wealth &amp; Compounding</h3>
                        <p class="rbc-article-snippet">How to balance non-custodial assets, high-yield treasury certificates, and multi-asset reserves to build lasting passive yield.</p>
                    </div>
                </div>
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Family Office</span>
                        <h3 class="rbc-article-title">Strategic Family Office Governance &amp; Generational Wealth Transfer</h3>
                        <p class="rbc-article-snippet">A structured framework for multi-generational trusts, succession protocols, and tax-sheltered cross-border wealth structures.</p>
                    </div>
                </div>
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Tax Mitigation</span>
                        <h3 class="rbc-article-title">10 Smart Year-End Tax Mitigation &amp; Capital Preservation Strategies</h3>
                        <p class="rbc-article-snippet">From loss harvesting to philanthropic endowments through appreciated equities, explore institutional wealth preservation.</p>
                    </div>
                </div>
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Enterprise Treasury</span>
                        <h3 class="rbc-article-title">Liquidity &amp; Working Capital Management for Scaling Enterprises</h3>
                ...
                <div class="rbc-article-card">
                    ...
                    <div class="rbc-article-body">
                        <span class="rbc-article-tag">Cyber Protection</span>
                        <h3 class="rbc-article-title">Safeguarding High-Net-Worth Portfolios Against Modern Cyber Threats</h3>
                        <p class="rbc-article-snippet">Crucial security protocols to protect corporate credentials, biometric tokens, and institutional wire authorizations.</p>
                    </div>
                </div>
            </div>
        </div>
