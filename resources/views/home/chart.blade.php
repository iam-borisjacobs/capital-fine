...
@section('content')
        ...
        <div class="fl-container">
            <div style="max-width: 720px; padding: 30px 0;">
                ...
                <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                    <a href="{{ route('rates') }}" class="fl-btn-signin" style="padding: 12px 28px; font-size: 1rem;">View All Rates <i class="fas fa-arrow-right"></i></a>
    ...
    <section class="fl-section" style="background-color: var(--fl-bg);">
        <div class="fl-container">
            <h2 class="fl-section-title">Major Foreign Exchange Benchmarks</h2>
            <p class="fl-section-subtitle">Real-time mid-market indicative conversion rates for primary trading pairs.</p>

            <div style="background: var(--fl-surface); border-radius: 12px; border: 1px solid var(--fl-border); overflow: hidden; box-shadow: var(--fl-shadow-md); margin-bottom: 40px;">
                <table style="width: 100%; border-collapse: collapse; text-align: left;">
                    <thead style="background: #f1f5f9; border-bottom: 2px solid var(--fl-border);">
                        <tr>
                            <th style="padding: 16px 20px; font-weight: 700; color: var(--fl-navy);">Currency Pair</th>
                            <th style="padding: 16px 20px; font-weight: 700; color: var(--fl-navy);">Platform Buys</th>
                            <th style="padding: 16px 20px; font-weight: 700; color: var(--fl-navy);">Platform Sells</th>
                            <th style="padding: 16px 20px; font-weight: 700; color: var(--fl-navy);">24h Trend</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr style="border-bottom: 1px solid var(--fl-border);">
