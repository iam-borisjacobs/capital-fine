        ...
        <div class="rbc-container" style="position: relative; z-index: 2;">
            <div style="max-width: 720px; padding: 40px 0;">
                ...
                <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                    <a href="{{ route('register') }}" class="rbc-btn-signin" style="padding: 12px 28px; font-size: 1rem;">Start Investing Online <i class="fas fa-arrow-right"></i></a>
                    <a href="{{ route('contact') }}" class="rbc-btn-secondary" style="border-color: #ffffff; color: #ffffff;">Book an Investment Advisor</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="rbc-section" style="background-color: var(--rbc-surface);">
        <div class="rbc-container">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
                <div>
                    <span class="rbc-badge-pill"><i class="fas fa-chart-pie"></i> HIGH-YIELD PORTFOLIOS</span>
                    <h2 class="rbc-section-title" style="text-align: left; margin-bottom: 16px;">Institutional-Grade Analytics &amp; Yield</h2>
                    ...
                    <ul class="rbc-feature-list" style="margin-bottom: 24px;">
                        <li class="rbc-feature-item"><span><strong>Guaranteed Return Certificates:</strong> Earn up to 5.15% fixed annual interest.</span></li>
                        <li class="rbc-feature-item"><span><strong>Automated Rebalancing:</strong> Keep asset allocations aligned with your risk tolerance.</span></li>
                        <li class="rbc-feature-item"><span><strong>Tax-Free Savings Integration:</strong> Maximize compounding returns with zero tax on gains.</span></li>
                    </ul>
                    <a href="{{ route('contact') }}" class="rbc-btn-primary">Connect with Wealth Manager</a>
                </div>
