...
<!-- HERO -->
        ...
        <div class="fl-container">
            <div style="max-width: 720px; padding: 30px 0;">
                ...
                <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                    <a href={{ route('login') }} class="fl-btn-signin" style="padding: 12px 28px; font-size: 1rem;">Access Client Portal <i class="fas fa-arrow-right"></i></a>
                    <a href={{ route('register') }} class="fl-btn-secondary" style="border-color: #ffffff; color: #ffffff;">Create Client Account</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="fl-section" style="background-color: var(--fl-bg);">
        <div class="fl-container">
            <h2 class="fl-section-title">Built for Performance and Total Security</h2>
            <p class="fl-section-subtitle">Cutting-edge digital tools designed to make every settlement faster, safer, and completely seamless.</p>

            <div class="fl-ecosystem-grid">
                <!-- Mobile Instrument Deposit -->
                <div class="fl-ecosystem-card">
                    <div style="font-size: 2.5rem; color: var(--fl-blue); margin-bottom: 12px;"><i class="fas fa-camera"></i></div>
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 8px;">Digital Instrument Clearance</h3>
                ...
                <div class="fl-ecosystem-card">
                    ...
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 8px;">Instant Global Card Freeze</h3>
                    <p style="font-size: 0.88rem; color: var(--fl-text-secondary); margin-bottom: 16px;">
                ...
                <div class="fl-ecosystem-card">
                    ...
                    <h3 style="font-size: 1.3rem; font-weight: 700; color: var(--fl-navy); margin-bottom: 8px;">FaceID &amp; Biometric Keys</h3>
                    <p style="font-size: 0.88rem; color: var(--fl-text-secondary); margin-bottom: 16px;">
