        ...
        <div class="fl-container" style="max-width: 900px;">
            <div class="fl-auth-card" style="margin: 0; max-width: 100%; padding: 40px;">
                ...
                <div style="color: var(--fl-text-secondary); line-height: 1.7; font-size: 0.95rem; display: flex; flex-direction: column; gap: 20px;">
                    <div>
                        <h3 style="color: var(--fl-navy); font-size: 1.2rem; margin-bottom: 6px;">1. Agreement to Terms</h3>
                    ...
                    <div>
                        <h3 style="color: var(--fl-navy); font-size: 1.2rem; margin-bottom: 6px;">2. Client Security &amp; Confidentiality</h3>
                    ...
                    <div>
                        <h3 style="color: var(--fl-navy); font-size: 1.2rem; margin-bottom: 6px;">3. Electronic Transactions &amp; Settlements</h3>
                    ...
                    <div>
                        <h3 style="color: var(--fl-navy); font-size: 1.2rem; margin-bottom: 6px;">4. 100% Security Guarantee Conditions</h3>
                    ...
                    <div>
                        <h3 style="color: var(--fl-navy); font-size: 1.2rem; margin-bottom: 6px;">5. Amendments &amp; Jurisdiction</h3>
