...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	Route::get('dashboard/frontend-images', [FrontendController::class, 'manageImages'])->name('manage_images');
	Route::get('dashboard/delimg/{id}', [FrontendController::class, 'delimg'])->name('delimg');
